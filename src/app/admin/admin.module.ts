...
import { ModalModule, TabsModule, TooltipModule, PopoverModule,BsDropdownModule } from 'ngx-bootstrap';
...
import { UserDesignationComponent } from '@app/main/userDesignation/userDesignation.component';
import { CreateUserDesignationComponent } from '@app/main/userDesignation/create-or-edit-userDesignation.component';
...
@NgModule({
    ...
    declarations: [
        ...
        CreateUserDesignationComponent
    ],
    exports: [
        AddMemberModalComponent
    ],
