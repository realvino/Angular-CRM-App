...
declare function notify(Id: number,name: string,email: string): any;
...
export class HeaderComponent extends AppComponentBase implements OnInit {
	...
	onToggleMenu(): void{
		this.menuOverlayShow = this.menuOverlayShow ? false : true;
    }
    
    // fullstory():void
    // {
    //     let email = this.appSession.user.emailAddress;
    //     let id = this.appSession.user.id;
    //     let name = this.appSession.user.userName;
    //     notify(id,name,email);
    // }
