...
export class CommonLookupModalComponent extends AppComponentBase {
    ...
    getRecords(event?: LazyLoadEvent): void {
        let maxResultCount = this.primengDatatableHelper.getMaxResultCount(this.paginator, event);
        let skipCount = this.primengDatatableHelper.getSkipCount(this.paginator, event);
