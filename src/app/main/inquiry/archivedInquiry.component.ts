...
@Component({
    templateUrl: './archivedInquiry.component.html',
    styleUrls: ['./createOReditModal.component.less']

})
export class ArchivedInquiryComponent extends AppComponentBase implements AfterViewInit{
  ...
  close() {
    this.active = false;
    this.router.navigate(["/app/main/sales-grid"]);  
  }
