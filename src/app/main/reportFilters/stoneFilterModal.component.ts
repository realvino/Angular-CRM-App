...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => StoneFilterComponent ),
  multi: true
};

@Component({
  selector: 'stoneFilterModal',
  templateUrl: './stoneFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class StoneFilterComponent  implements OnInit, ControlValueAccessor {
