...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => whybafcoFilterComponent ),
  multi: true
};

@Component({
  selector: 'whybafcoFilterModal',
  templateUrl: './whybafcoFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class whybafcoFilterComponent  implements OnInit, ControlValueAccessor {
