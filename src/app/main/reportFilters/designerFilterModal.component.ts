...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => DesignerFilterComponent),
  multi: true
};

@Component({
  selector: 'designerFilterModal',
  templateUrl: './designerFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class DesignerFilterComponent  implements OnInit, ControlValueAccessor {
