...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => SalesFilterComponent),
  multi: true
};

@Component({
  selector: 'salesFilterModal',
  templateUrl: './salesFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class SalesFilterComponent  implements OnInit, ControlValueAccessor {
