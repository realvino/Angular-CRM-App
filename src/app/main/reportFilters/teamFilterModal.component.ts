...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => TeamFilterComponent ),
  multi: true
};

@Component({
  selector: 'teamFilterModal',
  templateUrl: './teamFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class TeamFilterComponent  implements OnInit, ControlValueAccessor {
