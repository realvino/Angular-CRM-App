...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => StageFilterComponent ),
  multi: true
};

@Component({
  selector: 'stageFilterModal',
  templateUrl: './stageFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class StageFilterComponent  implements OnInit, ControlValueAccessor {
