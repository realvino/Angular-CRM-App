...
export class LocalizedResourcesHelper {
    ...
    private static loadLocalizedStlyes(): JQueryPromise<any> {
        ...
        $('head').append($('<link rel="stylesheet" type="text/css" />').attr('href', '/assets/metronic/admin/layout3/css/layout' + cssPostfix + '.css'));
        $('head').append($('<link rel="stylesheet" type="text/css" />').attr('href', '/assets/metronic/admin/layout3/css/themes/red-sunglo' + cssPostfix + '.css'));
